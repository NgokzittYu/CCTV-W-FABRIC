...
from services.detection_service import MerkleBatchManager, start_detection_loop, GOPAnchorManager
...
# Start GOP anchor manager — real-time GOP splitting + VIF/SHA-256 + Fabric anchoring
